  ...
  return (
    <div className="min-h-screen pb-24 bg-slate-950 text-slate-100">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-8 space-y-8">
        ...
        <div className="p-6 rounded-3xl border border-slate-800 bg-slate-900/70 backdrop-blur-md space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="font-bold text-sm text-slate-300">Live Order Lifecycle</h2>
          ...
          {order.orderStatus === FoodOrderStatus.COOKING && timeRemainingSeconds !== null && (
            <div className="p-5 rounded-2xl bg-gradient-to-r from-rose-950/80 via-slate-900 to-amber-950/80 border border-rose-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3 text-center sm:text-left">
                ...
                <div>
                  <h3 className="text-sm font-bold text-white">Chef is Preparing Your Food</h3>
        ...
        <div className="p-8 rounded-3xl border border-slate-800 bg-slate-900/90 text-slate-100 shadow-2xl space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-6 border-b border-slate-800 gap-4">
            ...
            <div className="sm:text-right space-y-1">
              ...
              <span className="inline-block px-2.5 py-0.5 rounded-full bg-slate-800 text-slate-300 text-[11px] font-semibold">
                {order.fulfillmentType === FoodFulfillmentType.HOME_DELIVERY
                  ? 'Home Delivery'
                  : 'Eat-in / Pickup'}
              </span>
              ...
              <tbody className="divide-y divide-slate-800/60 font-mono">
                {order.items.map((item) => (
                  <tr key={item.id} className="text-slate-200">
                    ...
                    <td className="py-3 text-center text-slate-400">৳{item.unitPriceBdt}</td>
          ...
          <div className="pt-4 border-t border-slate-800 flex justify-end">
            <div className="w-full sm:w-64 space-y-2 text-xs">
              ...
              <div className="flex justify-between text-base font-bold text-white pt-2 border-t border-slate-800">
                ...
                <span className="font-mono text-rose-400">৳{order.totalAmountBdt}</span>
              </div>
