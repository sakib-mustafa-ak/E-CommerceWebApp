...
export default function ApplicationsAdminPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-slate-900">Partner Application Review Queue</h1>
        ...
        {applications.length === 0 ? (
          ...
          <div className="space-y-3">
            {applications.map((app) => (
              <div
                key={app.id}
                className="p-4 rounded-2xl border border-slate-200 bg-slate-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-4"
              >
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="font-bold text-sm text-slate-900">{app.businessName}</h3>
                ...
                {app.status === 'PENDING_REVIEW' && (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-xl bg-red-50 hover:bg-red-500/30 text-red-700 font-semibold text-xs border border-red-200 transition-colors flex items-center gap-1"
                    >
